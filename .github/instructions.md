# Instructions for 8x Hiring Template
...
- **Auto-creates Free tier** on first login if no subscription exists ([../contexts/subscription-context.tsx](../contexts/subscription-context.tsx))

...
import { UserCircle, Upload, X, Loader2, Sparkles, AlertCircle } from "lucide-react"
...
export default function PersonReplacerPage() {
    ...
    if (!isLoading && !user) {
        router.push("/auth/login?returnUrl=/tools/person-replacer")
        return null
    }
            ...
            <div className="container mx-auto px-6 py-8">
                <div className="max-w-5xl mx-auto">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold">AI Person Replacer</h1>
                            <p className="text-muted-foreground">Replace people in photos with AI-generated alternatives.</p>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                            ...
                            {!isPro && (
                                <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-3 flex items-start gap-3 text-sm text-amber-600 dark:text-amber-400">
                                    ...
                                    <p>Free users get standard quality. Upgrade to Pro for HD results and faster processing.</p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="bg-card border border-border rounded-xl p-6 flex flex-col items-center justify-center min-h-[400px] relative overflow-hidden">
                            {isProcessing ? (
                                <div className="text-center space-y-4 relative z-10">
                                    ...
                                    <h3 className="text-xl font-medium animate-pulse">Replacing person...</h3>
                                    <p className="text-muted-foreground">AI is analyzing and generating replacement.</p>
                                </div>
                            ) : result ? (
                                ...
                                <div className="text-center text-muted-foreground max-w-xs">
                                    ...
                                    <p>Your AI-generated result will appear here after processing.</p>
                                </div>
                            )}
                        </div>
                    </div>
